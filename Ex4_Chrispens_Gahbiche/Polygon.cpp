...
//Constructors
Polygon::Polygon(std::string _Name,
...
std::array<double,2> Polygon::coord(int _Number) {
...
void Polygon::printNameCircumferenceArea(){
    std::cout << "############################" << std::endl;
...
double Polygon::distance(std::array<double, 2> x, std::array<double, 2> y) {
